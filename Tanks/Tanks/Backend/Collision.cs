...
namespace Tanks.Backend
{
    public class Collision
    {
        ...
        {
            foreach (var o in engine.Field.Objects.Where(o => o.Id != engine.Player.Id && !(o is Bullet)))
            {
            ...
            if (normalBullet == null) return Colliding.Nothing;
        ...
        {
            if (
                engine.Field.Objects.Where(o => o.Id != engine.Player.Id && !(o is Bullet))
                    .Select(player.Cuts)
                    .Where(cutting => cutting != Direction.Nothing)
                    .Any(cutting => animation.Direction == cutting))
                return Colliding.Collided;
